...
export default function ChatsLayout(props) {
  /** @type {[import("../types").UserStoreInfo, import("../types").SetCurrentUserFunction]} */
  const [currentUser, setCurrentUser] = createStore({
    username: "",
    email: "",
    id: "",
    invites: /** @type {import("../types").InviteInfo[]}*/ ([]),
    contacts: /** @type {import("../types").UserInfo[]}*/ ([]),
    requests: /** @type {import("../types").RequestsInfo[]}*/ ([]),
    numberOfContacts: 0,
    numberOfInvites: 0,
    numberOfRequests: 0,
